"""Tests for hugr.api.version() purity and CLI output equivalence.

- hugr.api.version() returns a dict; no stdout side-effects.
- The Click CLI command (hugr version --json) still emits identical JSON.
"""
...
from hugr.commands.version import run as version_cli_run
from hugr.failure import SubprocessResult
...
class TestApiVersionReturnShape:
    def test_returns_dict(self):
        with patch("hugr.commands.version.run_subprocess", side_effect=_stub_run_subprocess):
            result = api.version()
