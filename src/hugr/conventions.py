"""hugr's implementation of its own CLI contract.
...
hugr-conventions package after Phase 3a ships.
"""
...
def redact(text: Any) -> str:
  ...
  Defense-in-depth: hugr applies its own redaction on top of any
