...
_FUSED_VERBS = [
  ("ask", "mnem", "Ask across YAAMS, ledger, and live M365 buckets"),
  ("find", "mnem", "Typed search for people, events, messages, notes, or files"),
  ("inbox", "mnem", "One screen for unread mail, today's events, loops, and promotions"),
  ("remember", "mnem", "Capture a fact directly into the ledger layer"),
]
